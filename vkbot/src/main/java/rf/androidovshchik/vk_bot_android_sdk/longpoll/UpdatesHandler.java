...
import rf.androidovshchik.vk_bot_android_sdk.callbacks.CallbackDouble;
import rf.androidovshchik.vk_bot_android_sdk.callbacks.CallbackFourth;
import rf.androidovshchik.vk_bot_android_sdk.callbacks.CallbackTriple;
import rf.androidovshchik.vk_bot_android_sdk.clients.Client;
import rf.androidovshchik.vk_bot_android_sdk.objects.Chat;
...
import static rf.androidovshchik.vk_bot_android_sdk.clients.Client.service;
...
public class UpdatesHandler extends Thread {
     ...
     */
    void handle(JSONArray updates) throws JSONException {
     ...
     */
    private void handleCurrentUpdate() throws JSONException {
    ...
    private void handleChatEvents(JSONArray updateObject) throws JSONException {
     ...
     */
    @SuppressWarnings("unchecked")
    private void handleMessageUpdate(JSONArray updateObject) throws JSONException {
     ...
     */
    @SuppressWarnings("unchecked")
    private void handleTypingUpdate(JSONArray updateObject) throws JSONException {
