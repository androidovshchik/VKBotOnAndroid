...
public class Chat {
    ...
    public Chat(Client client, Integer chatId) {
        ...
        if (client instanceof Group) {
            Timber.e("Now groups can't work with chats, sorry.");
        }
    }
    ...
    public void setPhoto(String photo, Callback<Object> callback) throws JSONException {
            ...
            client.api().call("photos.getChatUploadServer", params_getMessagesUploadServer, response -> {
                try {
                    ...
                    if (!getPhotoStringResponse.has("response")) {
                        Timber.e("Bad response of uploading chat photo, no 'response' param: {} %s", getPhotoStringResponse.toString());
                        callback.onResult("false");
                        return;
                    }
