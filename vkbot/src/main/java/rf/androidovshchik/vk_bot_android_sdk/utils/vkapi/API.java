...
public class API {
    ...
    public static boolean executionStarted = false;
    ...
    public void call(String method, Object params, Callback<Object> callback) {
        ...
        try {
            ...
            Timber.e("Some error occured when calling VK API method {} with params {}, error is {} %s %s %s", method, params.toString(), e.toString());
        }
    }
    ...
    public void call(Callback<Object> callback, String method, Object... params) {
        ...
        try {
            ...
            Timber.e("Some error occured when calling VK API: {} %s", e.toString());
        }
    }
     ...
     */
    public JSONObject execute(String code) throws JSONException {
     ...
     * @see CallSync
     */
    public JSONArray execute(CallSync... calls) throws JSONException {
